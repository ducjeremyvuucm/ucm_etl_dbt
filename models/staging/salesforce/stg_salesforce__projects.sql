...
--            description__c as description,
            ...
            case when regexp_contains(ucm_project_id__c, 'N\\d{5}') then safe_cast(right(regexp_extract(ucm_project_id__c, 'N\\d{5}'),5) as int) else safe_cast(ucm_project_id__c as int) end as project_id,
